				...
				<div class="panel-group" id="accordion">
					<div class="panel  panel-primary">
						...
						<div class="panel-heading">
							<h6 class="panel-title">
								<a data-toggle="collapse" data-toggle="collapse"
									data-parent="#accordion" href="#score"> 成绩管理 </a>
							</h6>
						</div>
							...
							<div class="panel-body" style="background-color: #F9F9F9 "
								...
								<ul class="nav nav-pills  nav-stacked ">
									<li><a target="mainFrame" style="margin-right: -20px"
										href="${pageContext.request.contextPath}/user/getTeacherTcct?action=add">添加成绩
											<span class=" glyphicon glyphicon-chevron-right"></span> </a></li>
									<li><a target="mainFrame" style="margin-right: -20px"
										href="${pageContext.request.contextPath}/user/getTeacherTcct?action=query">查看所有成绩
											<span class=" glyphicon glyphicon-chevron-right"></span> </a></li>
											<li><a target="mainFrame" style="margin-right: -20px"
										href="${pageContext.request.contextPath}/user/preQueryScore">查询成绩
											<span class=" glyphicon glyphicon-chevron-right"></span> </a></li>
								</ul>
							</div>
						</div>
					...
					<div class="panel  panel-primary">
						...
						<div id="tcct" class="panel-collapse collapse ">
							<div class="panel-body" style="background-color: #F9F9F9 "
								...
								<ul class="nav nav-pills  nav-stacked ">
									<li><a target="mainFrame" style="margin-right: -20px"
										href="${pageContext.request.contextPath}/user/getTeacherTcct">查看教学安排
											<span class=" glyphicon glyphicon-chevron-right"></span> </a></li>
								</ul>
							</div>
						</div>
